...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-full shadow-lg z-50 transition text-sm"
      target="_blank"
    ...
    >
      ...
      <span className="font-medium leading-none">Contáctanos</span>
    </a>
  );
}